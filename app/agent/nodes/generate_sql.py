...
from app.core.sql_guard import sanitize_sql_text
...
async def generate_sql(state: DataAgentState, runtime: Runtime[DataAgentContext]):
    ...
    try:
        ...
        similar_query_cases = state.get("similar_query_cases") or []
        query = state["query"]
        ...
        result = await chain.ainvoke(
            {
                ...
                "similar_query_cases": yaml.dump(
                    similar_query_cases, allow_unicode=True, sort_keys=False
                ),
                "query": query,
            }
        )
