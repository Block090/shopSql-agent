...
class MetricQdrantRepository:
    ...
    async def ensure_collection(self, reset: bool = False):
        ...
        if reset and await self.client.collection_exists(self.collection_name):
    ...
    async def search(
        ...
        return [MetricInfo(**_entity_payload(point.payload)) for point in result.points]


def _entity_payload(payload: dict) -> dict:
