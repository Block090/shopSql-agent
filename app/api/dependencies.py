...
from app.repositories.qdrant.query_case_qdrant_repository import (
    QueryCaseQdrantRepository,
)
...
async def get_query_case_repository() -> QueryCaseQdrantRepository:
    """创建历史成功查询案例向量仓储。"""

    return QueryCaseQdrantRepository(qdrant_client_manager.client)
...
async def get_query_service(
    ...
    query_case_repository: Annotated[
        QueryCaseQdrantRepository, Depends(get_query_case_repository)
    ],
